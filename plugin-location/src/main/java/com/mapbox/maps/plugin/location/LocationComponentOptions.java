...
public class LocationComponentOptions implements Parcelable {
   ...
   * the first parameter of {@link com.mapbox.maps.plugin.delegates.MapStyleDelegate#addImage(String, Bitmap)}, the
   ...
   * {@link com.mapbox.maps.plugin.gestures.GesturesPluginImpl#setGesturesManager(AndroidGesturesManager, boolean, boolean)}.
   *
   ...
   * {@link com.mapbox.maps.plugin.delegates.MapStyleDelegate#addLayerAbove(Layer, String)}.
   * <p>
  ...
  /**
   * Gets the id of the layer that's referenced when placing the component on the map using
   * {@link com.mapbox.maps.plugin.delegates.MapStyleDelegate#addLayerBelow(Layer, String)}.
   * <p>
  ...
  /**
   * Enable or disable smooth animation of compass values for {@link com.mapbox.maps.plugin.location.modes.CameraMode}
   * and {@link com.mapbox.maps.plugin.location.modes.RenderMode}.
   *
  ...
  public static class Builder {
    ...
    public LocationComponentOptions build() {
      ...
      if (!TextUtils.isEmpty(locationComponentOptions.layerAbove()) && !TextUtils.isEmpty(locationComponentOptions.layerBelow())) {
     ...
     * @deprecated Use {@link com.mapbox.maps.CameraOptions.Builder()#padding(double, double, double, double)} instead.
     */
    @NonNull
    @Deprecated
